...
(function () { /*! (C) WebReflection Mit Style License */
    var CircularJSON = function (e, t) {
        function l(e, t, o) {
            var u = [],
                ...
                d;
            return function (e, v) {
                return t && (v = t.call(this, e, v)),
                e !== "" && (h !== this && (d = p - a.call(f, this) - 1, p -= d, f.splice(p, f.length), u.splice(p - 1, u.length), h = this), typeof v == "object" && v ? (a.call(f, v) < 0 && f.push(h = v), p = f.length, d = a.call(l, v), d < 0 ? (d = l.push(v) - 1, o ? (u.push(("" + e).replace(s, r)), c[d] = n + u.join(n)) : c[d] = c[0]) : v = c[d]) : typeof v == "string" && o && (v = v.replace(r, i).replace(n, r))),
                v
            }
        }
        function c(e, t) {
        ...
        function d(e, t, n) {
            for (var r in t) 
                t.hasOwnProperty(r) && (t[r] = v(e, t[r], n));
    ...
    instanceProto.onDestroy = function () {
        ...
        for (var name in ref) {
            if (Object.prototype.hasOwnProperty.call(ref, name) && ref[name].origin === this) {
                delete ref[name];
            }
        }
    };
    ...
    function syntaxHighlight(json) {
        ...
        }).replace(/\t/g, "&nbsp;&nbsp;") // to keep indentation in html.replace(/\n/g, "<br/>"); // to keep line break in html
    }
    ...
    instanceProto.getDebuggerValues = function (propsections) {
        ...
        function printReferences() {
            ...
            for (var r in self.type.plugin.references) {
                res += '<div style="border:1px solid #bbb; margin-bottom:3px;">' + '<div style="background:#fff;">"' + r + '"</div>' + syntaxHighlight(CircularJSON.stringify(self.type.plugin.references[r].value, null, "\t")) + '</div>';
            }
            return res;
        }
        ...
        propsections.push({
            ...
            "properties": [
                {
                    "name": "content",
                    "value": "<span style=\"cursor:text;-webkit-user-select: text;-khtml-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;\">" + syntaxHighlight(str) + "</span>",
                    "html": true,
                    "readonly": true
                }, {
                    "name": "shared references",
                    "value": "<span style=\"cursor:text;-webkit-user-select: text;-khtml-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;\">" + printReferences() + "</span>",
                    "html": true,
                    "readonly": true
                }
    ...
    instanceProto.getValueFromPath = function (from_current, path) {
        if (from_current) {
            return this.getValueFromPath(false, this.curPath.concat(path));
        } else {
            ...
            for (var i = 0; i < path_.length; i++) {
                if (value === undefined) {
                    logInvalidPath(path);
                    break;
                } else if (value === null) { // we avoid null 'cause null[i] will throw an error
                    if (i < path_.length - 1) {
    ...
    instanceProto.setValueFromPath = function (from_current, path, value) {
        ...
        if (from_current) {
            value = this.setValueFromPath(false, this.curPath.concat(path), value);
        } else {
            var path_ = [ROOT_KEY].concat(path);
            var obj = this.data;
            for (var i = 0; i < path_.length; i++) {
    ...
    // ////////////////////////////////////
    // Conditions
    function Cnds() {}Cnds.prototype.OnJSONParseError = function () {
        return true;
    };
        ...
        if (solModifierAfterCnds) {
            for (p in obj) {
                if (Object.prototype.hasOwnProperty.call(obj, p)) {
                    ...
                    /**PREVIEWONLY**/
                    if (this.runtime.hit_breakpoint) 
                        return;
    ...
    Acts.prototype.Delete = function (from_current, path) {
        ...
        if (path_.length === 0) {
            ...
            deleteIfValid(this.getValueFromPath(false, path_.slice(0, path_.length - 1) // go through all property but the last one
    ...
    Acts.prototype.Clear = function (from_current, path) {
        ...
        if (path_.length === 0) {
            ...
            clearIfValid(this.getValueFromPath(false, path_.slice(0, path_.length - 1) // go through all property but the last one
            ), path_[path_.length - 1]);
        }
    };
    ...
    // ////////////////////////////////////
    // Expressions
    function Exps() {}Exps.prototype.Size = function (ret) {
    ...
    Exps.prototype.Length = Exps.prototype.Size;
    // deprecated
